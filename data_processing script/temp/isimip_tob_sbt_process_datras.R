...
write_rds(df_hist_ssp126, file.path(dir_tob, "isimip_sbt_datras_hist_ssp126.rds"))
write_rds(df_hist_ssp370, file.path(dir_tob, "isimip_sbt_datras_hist_ssp370.rds"))
write_rds(df_hist_ssp585, file.path(dir_tob, "isimip_sbt_datras_hist_ssp585.rds"))
